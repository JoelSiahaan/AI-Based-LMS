...
export declare const testRedisClient: import("@redis/client").RedisClientType<{
    graph: {
...
export declare function createTestStudent(overrides?: any): Promise<{
    id: string;
    email: string;
    studentId: string;
    firstName: string;
...
export declare function createTestTeacher(overrides?: any): Promise<{
    id: string;
    email: string;
    firstName: string;
    lastName: string;
...
export declare function createTestCourse(teacherId: string, overrides?: any): Promise<{
    id: string;
    isActive: boolean;
    createdAt: Date;
    updatedAt: Date;
